...
public class Hilo_Procesos extends Thread{    
    ...
    public boolean VerifyP(Proceso _ver){
        ...
        System.out.println(GestorMemoria.RAM.MemoryFree+" :: "+GestorMemoria.RAM.BankMemory+" :: "+res);
        return res;
    }
    ...
    public void run(){
        ...
        while(process!=0){
            ...
            while(i<GestorMemoria.procesos.length){ //recorrer las filas mientras que el contador < cantidad de procesos
                if(GestorMemoria.procesos[i].Memoria>0 && VerifyP(GestorMemoria.procesos[i])){
